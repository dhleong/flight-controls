...
public enum SimEvent {
    ...
    GPS_ZOOM_IN("GPS_ZOOMIN_BUTTON"),
    GPS_ZOOM_OUT("GPS_ZOOMOUT_BUTTON"),
    GPS_DIRECT("GPS_DIRECTTO_BUTTON"),
    GPS_MENU("GPS_MENU_BUTTON"),
    GPS_CLEAR("GPS_CLEAR_BUTTON"),
    GPS_CLEAR_ALL("GPS_CLEAR_ALL_BUTTON"),
    GPS_ENTER("GPS_ENTER_BUTTON"),

    GPS_NEAREST("GPS_NEAREST_BUTTON"),
    GPS_OBS("GPS_OBS_BUTTON"),
    GPS_MESSAGE("GPS_MSG_BUTTON"),
    GPS_FLIGHT_PLAN("GPS_FLIGHTPLAN_BUTTON"),
    GPS_TERRAIN("GPS_TERRAIN_BUTTON"),
    GPS_PROCEDURE("GPS_PROCEDURE_BUTTON"),

    GPS_CURSOR("GPS_CURSOR_BUTTON"),
